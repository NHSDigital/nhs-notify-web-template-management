...
import { uploadBSLLetterTemplate } from './server-action';

const content = copy.pages.uploadDocxLetterTemplatePage('q4');
...
export default async function UploadLargePrintLetterTemplatePage() {
  ...
  return (
    <>
      ...
      <NHSNotifyMain>
        <NHSNotifyFormProvider serverAction={uploadBSLLetterTemplate}>
