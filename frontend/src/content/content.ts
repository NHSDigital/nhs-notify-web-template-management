...
const howToRequestADigitalProof: {
  ...
  content: [
    ...
    {
      type: 'text',
      text: '[Request a proof using ServiceNow (opens in a new tab)](https://nhsdigitallive.service-now.com/csm?id=sc_cat_item&sys_id=ce81c3ae1b1c5190892d4046b04bcb83).',
    },
  ],
};
