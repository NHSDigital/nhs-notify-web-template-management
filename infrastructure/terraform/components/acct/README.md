...
| <a name="input_enable_ecr_lifecycle"></a> [enable\_ecr\_lifecycle](#input\_enable\_ecr\_lifecycle) | Enable ECR lifecycle policy management for repository image retention | `bool` | `false` | no |
