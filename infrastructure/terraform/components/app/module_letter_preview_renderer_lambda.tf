module "letter_preview_renderer_lambda" {
  ...
  package_type           = "Image"
  image_uri              = "${var.aws_account_id}.dkr.ecr.${var.region}.amazonaws.com/${var.container_lambda_ecr_repo}:${var.project}-${var.environment}-letter-preview-renderer-${var.short_sha}"
