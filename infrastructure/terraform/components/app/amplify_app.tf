resource "aws_amplify_app" "main" {
  ...
  environment_variables = {
    ...
    USER_POOL_ID        = auth_remote_state.user_pool_id
    USER_POOL_CLIENT_ID = auth_remote_state.user_pool_client_id
    IDENTITY_POOL_ID    = auth_remote_state.identity_pool_id
  }
