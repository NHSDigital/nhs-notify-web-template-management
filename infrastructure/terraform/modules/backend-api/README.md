...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_approve_template_lambda"></a> [approve\_template\_lambda](#module\_approve\_template\_lambda) | https://github.com/NHSDigital/nhs-notify-shared-modules/releases/download/v3.0.6/terraform-lambda.zip | n/a |
...
| <a name="module_generate_letter_proof_lambda"></a> [generate\_letter\_proof\_lambda](#module\_generate\_letter\_proof\_lambda) | https://github.com/NHSDigital/nhs-notify-shared-modules/releases/download/v2.0.29/terraform-lambda.zip | n/a |
