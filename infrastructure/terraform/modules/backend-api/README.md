...
| <a name="input_base_component"></a> [base\_component](#input\_base\_component) | The top level component containing this module | `string` | n/a | yes |
...
| <a name="module_sftp_upload_queue"></a> [sftp\_upload\_queue](#module\_sftp\_upload\_queue) | git::https://github.com/NHSDigital/nhs-notify-shared-modules.git//infrastructure/modules/sqs | v1.0.9 |
