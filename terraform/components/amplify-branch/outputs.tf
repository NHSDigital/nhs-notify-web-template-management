...
output "app_basic_auth_username" {
  value     = data.aws_ssm_parameter.amplify_app_username.value
  sensitive = true
}

output "app_basic_auth_password" {
  value     = data.aws_ssm_parameter.amplify_app_password.value
  sensitive = true
}
