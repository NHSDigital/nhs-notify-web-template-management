...
export type Language = 'ar' | 'bg' | 'bn' | 'de' | 'el' | 'en' | 'es' | 'fa' | 'fr' | 'gu' | 'hi' | 'hu' | 'it' | 'ku' | 'lt' | 'lv' | 'ne' | 'pa' | 'pl' | 'pt' | 'ro' | 'ru' | 'sk' | 'so' | 'sq' | 'ta' | 'tr' | 'ur' | 'zh';
...
export type GetV1TemplateByTemplateIdError = GetV1TemplateByTemplateIdErrors[keyof GetV1TemplateByTemplateIdErrors];
...
export type GetV1TemplateByTemplateIdResponse = GetV1TemplateByTemplateIdResponses[keyof GetV1TemplateByTemplateIdResponses];
...
export type PostV1TemplateByTemplateIdError = PostV1TemplateByTemplateIdErrors[keyof PostV1TemplateByTemplateIdErrors];
...
export type PostV1TemplateByTemplateIdResponse = PostV1TemplateByTemplateIdResponses[keyof PostV1TemplateByTemplateIdResponses];
...
export type PostV1TemplateError = PostV1TemplateErrors[keyof PostV1TemplateErrors];
...
export type PostV1TemplateResponse = PostV1TemplateResponses[keyof PostV1TemplateResponses];
...
export type GetV1TemplatesError = GetV1TemplatesErrors[keyof GetV1TemplatesErrors];
